class givemprojectpm {
  String? message;
  List<Data>? data;
  int? statuscode;
  int? totalCount;

  givemprojectpm({this.message, this.data, this.statuscode, this.totalCount});

  givemprojectpm.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  dynamic productService;
  dynamic subProductService;
  int? progressId;
  ...
  dynamic deliveryEstimateDate1;
  String? tokenId;
  dynamic empDescription;
  dynamic updateByy;
  String? progressUpdateDate;
  dynamic progressUpdateBy;
  String? allocateDate;
  String? uploadAllotFile;
  String? aStatus;
  String? taskTittle;
  String? endDeliveryEstimateDate;
  dynamic endDeliveryEstimateDate1;
  String? recurrence;
  String? priority;
  bool? isActive;
  String? createdDate;
